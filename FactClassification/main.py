...
from data_loader import FCDataset
from torch.utils.data import DataLoader
from config import fc_setting
...
def run(args):
    ...
    train_set = FCDataset("train", label2ids, tok, args.max_length)
    val_set = FCDataset("dev", label2ids, tok, args.max_length)
...
# nohup python -u main.py -p --model_pt cls >test.out 2>&1 &
# nohup python -u cmain.py >train.out 2>&1 &
